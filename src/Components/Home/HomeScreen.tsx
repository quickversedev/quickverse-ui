...
//   // Function to request location permission for iOS
...
//         const campusId =
//           campuses && autoSelectCampus(latitude, longitude, campuses);
//         if (campusId) {
//           setSelectedCampusId(campusId);
//           setCampus(campusId); // Save selected campus to storage
//         } else {
//           setSelectedCampusId('IIMU-313001'); // Default campus
//           setCampus('IIMU-313001'); // Save selected campus to storage
...
//     // console.log('No campus found within the radius.');
...
//     // setSelectedCampusId(savedCampus || 'IIMU-313001'); // Default campus
//   }, []);
//   useEffect(() => {
//     if (selectedCampusId) {
